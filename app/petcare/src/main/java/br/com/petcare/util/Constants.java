...
public class Constants {
	...
	public static String REDIRECT_CADASTRAR_SERVICO = "redirect:/servico/cadastrar";
	
	public static String REDIRECT_LISTAR_SERVICO = "redirect:/servico/listar";
